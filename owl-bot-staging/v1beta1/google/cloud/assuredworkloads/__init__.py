...
from google.cloud.assuredworkloads_v1beta1.types.assuredworkloads import RestrictAllowedServicesRequest
from google.cloud.assuredworkloads_v1beta1.types.assuredworkloads import RestrictAllowedServicesResponse
