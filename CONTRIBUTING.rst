...
- Clone your fork of ``python-assured-workloads`` from your GitHub account to your local
  ...
  as ``hack-on-python-assured-workloads``.  E.g.::
   ...
   $ cd ${HOME}
   $ git clone git@github.com:USERNAME/python-assured-workloads.git hack-on-python-assured-workloads
   ...
   $ git remote add upstream git@github.com:googleapis/python-assured-workloads.git
...
- In order to make ``nox -s lint`` run faster, you can set some environment
  ...
  version of ``python-assured-workloads``. The the suggested remote name ``upstream``
...
.. _config: https://github.com/googleapis/python-assured-workloads/blob/master/noxfile.py
